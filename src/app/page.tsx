            ...
            {BEST_PLACES.map((place, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className={`min-w-[calc(100vw-32px)] max-w-[calc(100vw-32px)] sm:min-w-[340px] sm:max-w-none ${isActive ? "lg:min-w-[calc(40%-18px)] lg:max-w-[calc(40%-18px)]" : "lg:min-w-[calc(20%-18px)] lg:max-w-[calc(20%-18px)]"} flex-shrink-0 min-h-[360px] md:min-h-[440px] group relative overflow-hidden rounded-3xl border border-slate-800 bg-slate-950 flex flex-col justify-end p-6 transition-all duration-500 ease-in-out transform hover:-translate-y-1.5 hover:border-amber-500/40 hover:shadow-[0_15px_30px_rgba(245,158,11,0.15)] cursor-pointer snap-start`}
                >
